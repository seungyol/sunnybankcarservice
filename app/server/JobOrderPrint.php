...
<html>
	...
	div.divTop ul {margin-top:0px;padding-left:10px;}
	div.divCustomer { width:200px;height:140px;}
	div.divCar { width:260px;height:140px;border-left:none;}
	...
	div.JobDescription {width:691px; height:240px;}
	div.JobDescription > span {width: 691px;display: block; bold;padding: 10px;}
	div.JobDescription > span > label {font-weight: bold;}
	...
	<div class='divCar' >
		<span>
			<ul class='Car'>
				...
				<li><label class='short'>Engine No :</label><span><?php if(empty($custCars["EngineNo"])) {echo "&nbsp;";}else {echo $custCars["EngineNo"];}?></span></li>
